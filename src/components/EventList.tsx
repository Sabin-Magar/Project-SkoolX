...
const EventList = async ({ dateParam }: { dateParam: string | undefined }) => {
  ...
  // ── Fix: show events ACTIVE on selected date, not just events that start on it ──
  // An event is active on a date if:
  //   startTime <= end of that day  AND  endTime >= start of that day
