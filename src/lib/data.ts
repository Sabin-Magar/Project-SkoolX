...
export const calendarEvents = [
  {
    ...
    end: new Date(2026, 2, 27, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 2, 27, 9, 0),
    end: new Date(2026, 2, 27, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 2, 27, 10, 0),
    end: new Date(2026, 2, 27, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 2, 27, 11, 0),
    end: new Date(2026, 2, 27, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 2, 27, 13, 0),
    end: new Date(2026, 2, 27, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 2, 27, 14, 0),
    end: new Date(2026, 2, 27, 14, 45),
  },

  {
    ...
    end: new Date(2026, 2, 28, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 2, 28, 10, 0),
    end: new Date(2026, 2, 28, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 2, 28, 11, 0),
    end: new Date(2026, 2, 28, 11, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 2, 28, 14, 0),
    end: new Date(2026, 2, 28, 14, 45),
  },

  {
    title: "Math",
    allDay: false,
    start: new Date(2026, 2, 29, 8, 0),
    end: new Date(2026, 2, 29, 8, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 2, 29, 10, 0),
    end: new Date(2026, 2, 29, 10, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 2, 29, 13, 0),
    end: new Date(2026, 2, 29, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 2, 29, 14, 0),
    end: new Date(2026, 2, 29, 14, 45), // ✅ fixed
  },

  {
    ...
    end: new Date(2026, 2, 30, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 2, 30, 10, 0),
    end: new Date(2026, 2, 30, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
...

  {
    ...
    end: new Date(2026, 2, 31, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 2, 31, 9, 0),
    end: new Date(2026, 2, 31, 9, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 2, 31, 11, 0),
    end: new Date(2026, 2, 31, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 2, 31, 13, 0),
    end: new Date(2026, 2, 31, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 2, 31, 14, 0),
    end: new Date(2026, 2, 31, 14, 45),
  },
];